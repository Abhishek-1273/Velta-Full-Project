...
const sections = [
    {
        ...
        clauses: [
            { title: '1. Acceptance of Terms', content: (<p>By accessing or using Velta's services, you agree to these Terms of Service with Velta AI. If you do not agree, please do not use our services.</p>) },
            { title: '2. Description of Service', content: (<p>Velta AI is a revenue operations and lead management platform. Velta AI provides software, automation workflows, and integration services only. We are a technology service provider — we do not provide sales, marketing, or business advisory services.</p>) },
            { title: '3. No Guarantee of Results', content: (<p>Velta AI makes no guarantee, express or implied, regarding revenue, sales, leads, conversions, or return on investment (ROI). Business outcomes depend entirely on the Client's own efforts, market conditions, and use of the platform.</p>) },
            ...
            { title: '5. Third-Party Services', content: (<p>Velta AI integrates with third-party providers including WhatsApp, Meta, Evolution API, AppSheet, Google services, AI providers, hosting providers, SMS providers, and email providers. Velta AI is not responsible for outages, policy changes, pricing changes, account bans, suspensions, or restrictions imposed by any third-party provider.</p>) },
            { title: '6. Limitation of Liability', content: (<p>To the maximum extent permitted by law, Velta AI shall not be liable for lost profits, lost revenue, business interruption, indirect or consequential damages, or any losses arising from third-party service failures. Our total liability is limited to the fees paid by the Client in the three (3) months preceding the claim.</p>) },
    ...
    },
    {
        ...
        clauses: [
            { title: '1. Introduction', content: (<p>Velta AI ("we", "our") respects the privacy of our clients and their customers. This Privacy Policy explains how we collect, use, and protect information when you use Velta's services.</p>) },
            { title: '2. Information We Collect', content: (<><p>We may collect the following types of information:</p><ul><li>Account information: name, email address, company name, billing details.</li><li>Service usage data: logs, configurations, and activity related to your Velta account.</li><li>Client business data: lead records, contact information, and messages processed through the platform on your behalf.</li></ul></>) },
    ...
    },
    {
        ...
        clauses: [
            { title: '1. Parties', content: (<p>This Client Service Agreement is entered into between Velta AI ("Service Provider") and the Client as identified during onboarding ("Client").</p>) },
            { title: '2. Scope of Services', content: (<><p>Velta AI agrees to provide the following under the agreed service plan:</p><ul><li>Access to the Velta platform and its automation features.</li><li>Setup and configuration of workflows, integrations, and dashboards as per the agreed scope.</li><li>Technical support as defined in the selected service tier.</li><li>Ongoing maintenance and updates to the platform.</li></ul><p>Any services outside the agreed scope will be subject to a separate written change order and additional fees.</p></>) },
            ...
            { title: '4. Third-Party Charges', content: (<p>The Client acknowledges and accepts responsibility for all third-party charges arising from use of the platform, including but not limited to: WhatsApp messaging fees, Meta API costs, AppSheet licenses, AI provider usage, hosting fees, SMS costs, and email delivery costs. These charges are separate from Velta AI fees.</p>) },
            { title: '5. Service Availability', content: (<p>Velta AI will use commercially reasonable efforts to maintain service uptime. However, we cannot guarantee uninterrupted service due to third-party dependencies, scheduled maintenance, or factors beyond our control.</p>) },
            { title: '6. Intellectual Property', content: (<p>All platform software, workflows, templates, and tools developed by Velta AI remain the intellectual property of Velta AI. The Client retains full ownership of their business data and content.</p>) },
    ...
    },
    {
        ...
        clauses: [
            { title: '1. Overview', content: (<p>This policy outlines the terms under which refunds and cancellations are handled for all Velta services. By purchasing our services, you agree to this policy.</p>) },
            { title: '2. Setup Fees — Non-Refundable', content: (<p>All one-time setup fees, onboarding fees, and implementation fees are strictly non-refundable once implementation has begun. This covers the time, resources, and technical work invested in configuring your Velta environment.</p>) },
            ...
            { title: '4. Cancellation Process', content: (<p>To cancel your subscription, the Client must provide written notice to Velta AI at least 30 days before the next billing date. Cancellation requests should be sent to the Velta team. Services will continue until the end of the current paid period.</p>) },
            { title: '5. Effect of Cancellation', content: (<><p>Upon cancellation or termination:</p><ul><li>Access to the Velta platform will be disabled at the end of the current period.</li><li>Server-side automations, hosted workflows, and active integrations will be shut down.</li><li>Clients may request a data export before the termination date where technically feasible.</li><li>No partial refunds will be issued for unused days within a billing period.</li></ul></>) },
            { title: '6. Exceptional Circumstances', content: (<p>Refunds may be considered at Velta AI's sole discretion in cases of proven technical failure directly attributable to Velta AI (not third-party providers) that renders the Service completely unusable. Any such request must be submitted in writing within 7 days of the issue.</p>) },
            { title: '7. Third-Party Costs', content: (<p>Velta AI does not control and cannot refund costs charged by third-party providers (WhatsApp, Meta, AppSheet, AI services, hosting, SMS, email providers, etc.). Clients must resolve such billing matters directly with the respective providers.</p>) },
    ...
    },
    {
        ...
        clauses: [
            ...
            { title: '4. Late Payments', content: (<><p>If an invoice remains unpaid beyond the due date:</p><ul><li>Velta AI reserves the right to suspend all services immediately, including platform access, automations, reports, integrations, and technical support.</li><li>A late payment fee of 2% per month may be applied to the outstanding balance.</li><li>Services will be reinstated only upon full payment of all outstanding amounts.</li></ul></>) },
            { title: '5. Price Changes', content: (<p>Velta AI reserves the right to revise service pricing with 30 days advance written notice to the Client. Continued use of the Service after the effective date of a price change constitutes acceptance of the new pricing.</p>) },
            { title: '6. Third-Party Charges', content: (<p>Clients are solely responsible for paying all charges billed by third-party providers including WhatsApp API, Meta, AppSheet, AI providers, hosting services, SMS gateways, and email platforms. These costs are not included in Velta AI's fees and are billed directly by the respective providers.</p>) },
            { title: '7. Disputed Invoices', content: (<p>If a Client believes an invoice is incorrect, they must notify Velta AI in writing within 5 days of receiving the invoice. Undisputed portions of the invoice must be paid by the due date. Both parties will work in good faith to resolve billing disputes promptly.</p>) },
    ...
    },
    {
        ...
        clauses: [
            { title: '1. Overview', content: (<p>This policy describes how Velta AI collects, processes, and handles Client data in connection with the Velta platform, and clarifies the ownership rights of all parties.</p>) },
            { title: '2. Client Data Ownership', content: (<p>The Client retains full and exclusive ownership of all business data entered into or processed through the Velta platform. This includes, but is not limited to: lead records, contact lists, conversation data, sales pipeline information, and customer information. Velta AI claims no ownership over Client data.</p>) },
            { title: '3. Velta AI\'s Role as Data Processor', content: (<><p>Velta AI acts as a data processor on behalf of the Client. We process Client data solely for the purpose of delivering the agreed services, including:</p><ul><li>Operating and maintaining platform automations and workflows.</li><li>Generating reports and dashboards based on Client data.</li><li>Enabling integrations with third-party tools as configured by the Client.</li></ul><p>We do not use Client data for any purpose beyond service delivery.</p></>) },
            { title: '4. Data Storage & Security', content: (<p>Client data is stored on secure servers with appropriate technical and organisational safeguards. Velta AI employs access controls, encryption in transit, and regular security reviews to protect Client data from unauthorised access.</p>) },
            ...
            { title: '7. Data Deletion on Termination', content: (<p>Upon termination or expiry of the service, Velta AI will securely delete or anonymise all Client data within 90 days, unless a longer retention period is required by applicable law. The Client should ensure they have exported all necessary data before termination.</p>) },
            { title: '8. Compliance Responsibility', content: (<p>The Client is responsible for ensuring their use of the Velta platform complies with applicable data protection laws, including rules governing the collection and use of personal data belonging to their customers. Velta AI is not responsible for the Client's compliance with data protection obligations in their own jurisdiction or industry.</p>) },
            { title: '9. Data Breach Notification', content: (<p>In the event of a confirmed data breach affecting Client data, Velta AI will notify the Client promptly and take appropriate remedial action. Clients should also notify their customers as required by applicable law.</p>) },
        ],
    },
]
    ...
    return (
        <div className="terms-container">
            ...
            <div className="terms-header">
                ...
                <p>Version 1.0 | Effective 1 July 2026 | Velta AI — WhatsFlow</p>
            </div>
                ...
                <div className="terms-body" ref={contentRef}>
                    <div className="terms-doc-header">
                        ...
                        <div>
                            ...
                            <p className="doc-meta">Effective Date: 1 July 2026 | Velta AI — WhatsFlow</p>
                        </div>
                    </div>
            ...
            <div className="terms-footer">
                <p className="footer-copy">© 2026 Velta AI. All rights reserved. | www.veltalabs.net</p>
